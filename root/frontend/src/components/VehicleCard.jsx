...
const VehicleCard = ({Image, Name, Price, id, Model, ImgModel, Consumption, FuelType}) => {
	return (
		<div key={id} className='bg-[#f5f6fa] rounded-md hover:translate-y-[-0.5rem] ease-in-out duration-300 mt-[20px]
						hover:shadow-[3px_3px_10px_6px_rgba(0,0,0,0.2)] h-[450px] shadow-xl w-[370px] cursor-pointer'>
